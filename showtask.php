...
<h2 style="padding:20px;">SHOW TASK</h2>
<div class="task-container">
        ...
        <div class="task-row">
            ...
            <div style="margin-left:10px;display:flex;">
                 <button type="submit" name="action" value="show" class="icon-btn edit-btn" data-taskid="{$users['taskId']}">
                 <i class="bi bi-pencil-square" title="edit"></i></button>
        ...
        ?>
<form action="edittask.inc .php" method="post"></form>
    </div>
